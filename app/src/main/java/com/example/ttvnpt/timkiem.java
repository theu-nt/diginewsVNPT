...
//    ArrayList<website> arrayList = new ArrayList<>();
    ...
    private void ActionToolbar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ArrayList<String>arr1=new ArrayList<>();
                ArrayList<KeySearch> keySearches= (ArrayList<KeySearch>) DatabaseNews.getInstance(getApplicationContext()).daoNews().getListKeySearch();
                if (keySearches.size()>0) {
                    for (KeySearch keySearch : keySearches) {
                        arr1.add(keySearch.getKey());
                    }
